...
public class PrettyContext implements Serializable
{
     ...
     * method will recursively call any dynamic mapping viewId functions as
     * needed until a String viewId is returned, or supplied by a static
     * mapping.
     * <p>
     ...
     * query string. This may be different from the originalUri because it can
     * be generated through calculation of a dynamic viewId.
     */
     ...
     * {@link PrettyConfigurator} (This can be dynamically manipulated at
     * runtime in order to change or add any mappings.
     */
