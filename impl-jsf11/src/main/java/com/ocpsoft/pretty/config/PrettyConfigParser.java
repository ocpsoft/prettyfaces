...
public interface PrettyConfigParser
{
    ...
    * 
    * @param builder target builder, must not be <code>null</code>.
    * @param resource input stream to be parsed, must not be <code>null</code>
    * @throws IOException If input stream could not be read.
    * @throws SAXException If configuration could not be parsed.
    */
